...
app = FastAPI(title="Backend Service Mon Assiette bla bla", version="0.1.0")
...
@app.get("/")
async def read_root():
    return {"message": "Bienvenue sur le service backend deploy le 08 janvier 2026 mlsijg meori jgerpoigjerp ogij!"}
